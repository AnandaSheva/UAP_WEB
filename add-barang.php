              ...
              <div class="card-body">
                <div class="table-responsive">
                  <form action="" method="POST">
                    ...
                    <button type="submit" name="btn-simpan" class="btn btn-success mt-5">Simpan</button>
                    <button type="submit" name="btn-simpan" class="btn btn-secondary mt-5" onclick="back()">Batal</button>
                  </form>
