<?php 
    ...
    $query_select = mysqli_query($mysqli, "SELECT * FROM barang_masuk WHERE id_masuk = '$_GET[update]'");
    $query_get_tanggal = mysqli_query($mysqli, "SELECT * FROM `barang_masuk`");
...
<head>
    ...
    <title>GoGroceries - Stok Masuk</title>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          >
            ...
            <!-- Topbar Navbar -->
            <a class="nav-link d-flex align-items-center" href="stokmasuk.php" >
                <i class="fas fa-fw fa-box-open" style="color:#6e707e"></i>
                <h1 class="h4 mb-0 text-gray-700 font-weight-bold" style="margin-left: 10px">Stok Masuk</h1>
            </a>
            <i class="fas fa-fw fa-chevron-right"></i>
            <a class="nav-link d-flex align-items-center" href="edit-stokmasuk.php" >
            <i class="fas fa-fw fa-pen mr-2" style="color:#6e707e"></i>
                <h1 class="h4 mb-0 text-gray-700 font-weight-bold" style="margin-left: 10px">Edit Stok Masuk</h1>
            </a>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  <div class="form-group">
                        <label for="id_masuk">ID Barang <i class="fas fa-star-of-life" style="font-size: 7px; vertical-align: top; color: #ED2939"></i></label>
                        <input type="text" class="form-control shadow-sm" id="id_masuk" name="id_masuk" value="<?= $result['id_masuk']; ?>" readonly>
                    </div>

                    <div class="form-group">
                        <label for="tanggal_masuk">Tanggal <i class="fas fa-star-of-life" style="font-size: 7px; vertical-align: top; color: #ED2939"></i></label>
                        <input type="date" class="form-control w-25 shadow-sm" id="tanggal_masuk" name="tanggal_masuk" value="<?= $result['tanggal']; ?>" required>
                    </div>
                  ...
                  <?php
                    if(isset($_POST['btn-simpan'])) {
                      ...
                      $query_update = mysqli_query($mysqli, "UPDATE `barang_masuk` SET 
                      `id_masuk`='$id_masuk',
                      `tanggal`='$tanggal_masuk',
                      `jumlah_barang`='$jumlah_barang' WHERE `id_masuk` = '$id_masuk'");
