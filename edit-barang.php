<?php 
    ...
    $query_select = mysqli_query($mysqli, "SELECT * FROM barang WHERE id_barang = '$_GET[update]'");
...
<head>
    ...
    <title>GoGroceries - Edit Barang</title>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          >
            ...
            <!-- Topbar Navbar -->
            <a class="nav-link d-flex align-items-center" href="barang.php" >
            ...
            <a class="nav-link d-flex align-items-center" href="" >
                ...
                <h1 class="h4 mb-0 text-gray-700 font-weight-bold">Edit Barang</h1>
            </a>
                ...
                <div class="table-responsive">
                  <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control shadow-sm" id="id_barang" name="id_barang" value="<?= $result['id_barang']; ?>" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control shadow-sm" id="nama_barang" name="nama_barang" placeholder="Masukkan Nama Barang" value="<?= $result['nama_barang']; ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_barang" id="jenis_barang" class="form-control shadow-sm" required>
                          ...
                          <?php while($jenis = mysqli_fetch_assoc($query_get_jenis)) {
                            $selected_jenis = ($jenis['id_jenisbarang'] == $result['id_jenisbarang']) ? 'selected' : '';
                            ?>
                          <option value="<?= $jenis['id_jenisbarang']; ?>" <?= $selected_jenis; ?>><?php echo $jenis['jenis']; ?></option>
                          <?php } ?>
                        </select>
                    </div>
                  ...
                  <?php
                    if(isset($_POST['btn-simpan'])) {
                      ...
                      $query_update = mysqli_query($mysqli, "UPDATE `barang` SET 
                      `nama_barang`='$nama_barang',
                      `id_jenisbarang`='$jenis_barang',
                      `id_lokasi`='$lokasi_barang' WHERE `id_barang` = '$id_barang'");
