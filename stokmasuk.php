<?php 
    ...
    $query_table = mysqli_query($mysqli, "SELECT id_masuk, id_barang, jumlah_barang, tanggal
                                        FROM barang_masuk
                                        WHERE barang_masuk.id_barang = barang_masuk.id_barang AND 
                                        barang_masuk.id_masuk = barang_masuk.id_masuk");
?>
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <a href="add-stokmasuk.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
                ...
                <div class="table-responsive">
                  ...
                  >
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $result['id_masuk'] ?></td>
                            <td><?= $result['id_barang'] ?></td>
                            <td><?= $result['jumlah_barang'] ?></td>
                            <td><?= $result['tanggal'] ?></td>
                            <td>
                            <a href="edit-stokmasuk.php?update=<?= $result['id_masuk']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                <i class="fas fa-fw fa-pen"></i>
                              </a>
                              <span class="mr-1"></span>
                              <a href="#" class="btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#hapusBarangMasuk<?= $result['id_masuk'] ?>" data-toggle="tooltip" data-placement="top" title="Hapus">
                        ...
                        <div
                          class="modal fade"
                          id="hapusBarangMasuk<?= $result['id_masuk'] ?>"
                          tabindex="-1"
                          role="dialog"
  ...
  if(isset($_POST['btn-hapus'])) {
    ...
    if($query_delete) {
      ...
      <script>
        Swal.fire({
          title: "Gagal!",
          text: "Data Stok Masuk Gagal Dihapus!",
          icon: "error"
        }).then(function() {
          window.location.href = 'stokmasuk.php';
        });
