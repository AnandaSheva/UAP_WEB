...
<head>
    ...
    <title>Toolventory - Barang Masuk</title>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          >
            ...
            <a class="nav-link d-flex align-items-center" href="add-stokmasuk.php" >
                <i class="fas fa-fw fa-plus mr-2" style="color:#6e707e"></i>
                <h1 class="h4 mb-0 text-gray-700 font-weight-bold" style="margin-left: 10px">Tambah Stok Masuk</h1>
            </a>
                ...
                <div class="table-responsive">
                  <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control w-25 shadow-sm" id="tanggal_masuk" name="tanggal_masuk" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control w-25 shadow-sm" id="jumlah_barang" name="jumlah_barang" required>
                    </div>
                  ...
                  <?php
                    if(isset($_POST['btn-simpan'])) {
                      ...
                      $query_insert = mysqli_query($mysqli, "INSERT INTO `barang_masuk`(`id_barang`, `jumlah_barang`, `tanggal`) VALUES ('$barang','$jumlah_barang','$tanggal')");
                      ...
                      if($query_insert) {
                        ...
                        <script>
                          Swal.fire({
                            ...
                            icon: "success"
                             ...
                             window.location.href = 'stokmasuk.php'; // Redirect after the user clicks "OK"
                           });
                        </script>
                        ...
                        <script>
                          Swal.fire({
                            title: "Gagal!",
                            text: "Data Stok Masuk Gagal Ditambahkan!",
                            icon: "error"
                          }).then(function() {
                             window.location.href = 'stokmasuk.php'; // Redirect after the user clicks "OK"
                           });
