      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          >
            ...
            <!-- Topbar Navbar -->
            <a class="nav-link d-flex align-items-center" href="laporan.php" >
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <span>
                    <a href="add-barang.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
                  ...
                  <table
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="edit-barang.php?update=<?= $result['id_barang']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
