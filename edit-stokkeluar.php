<?php 
    ...
    $query_select = mysqli_query($mysqli, "SELECT * FROM barang_keluar WHERE id_keluar = '$_GET[update]'");
    $query_get_tanggal = mysqli_query($mysqli, "SELECT * FROM `barang_keluar`");
              ...
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  <div class="form-group">
                        <label for="id_keluar">ID Barang <i class="fas fa-star-of-life" style="font-size: 7px; vertical-align: top; color: #ED2939"></i></label>
                        <input type="text" class="form-control shadow-sm" id="id_keluar" name="id_keluar" value="<?= $result['id_keluar']; ?>" readonly>
                    </div>

                    <div class="form-group">
                        <label for="tanggal_keluar">Tanggal <i class="fas fa-star-of-life" style="font-size: 7px; vertical-align: top; color: #ED2939"></i></label>
                        <input type="date" class="form-control w-25 shadow-sm" id="tanggal_keluar" name="tanggal_keluar" value="<?= $result['tanggal']; ?>" required>
                    </div>
                    ...
                    <a href="stokkeluar.php" class="btn btn-secondary mt-4">Kembali</a>
                  </form>
                  ...
                  <?php
                    if(isset($_POST['btn-simpan'])) {
                      ...
                      $query_update = mysqli_query($mysqli, "UPDATE `barang_keluar` SET 
                      `id_keluar`='$id_keluar',
                      `tanggal`='$tanggal_keluar',
                      `jumlah_barang`='$jumlah_barang' WHERE `id_keluar` = '$id_keluar'");
                      ...
                      if($query_update) {
                        ...
                        <script>
                          Swal.fire({
                            title: "Berhasil!",
                            text: "Data Stok Keluar Berhasil Diubah!",
                            icon: "success"
                          }).then(function() {
