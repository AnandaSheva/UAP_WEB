    ...
    <div id="wrapper">
      ...
      >
        ...
        <li class="nav-item active">
          <a class="nav-link" href="admin-barang.php">
        ...
        <!-- Nav Item - Barang -->
        <li class="nav-item">
          <a class="nav-link" href="admin-barangmasuk.php">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <a href="admin-tambahbarang.php" class="d-none d-sm-inline-block btn btn-sm btn-success rounded-pill shadow-sm">
